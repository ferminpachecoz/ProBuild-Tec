...
export default function LineaMaquinas({principales, additionals}) {
  return (
    <div className='linea-maquinas'>
      ...
      <div className='row row-cols-1 row-cols-lg-2 title'>
      ...
      <div className='row row-cols-1 row-cols-lg-2 title'>
        ...
        <p>Consulta las máquinas opcionales disponibles para personalizar tu fábrica. Agrega equipamiento adicional según tus necesidades para mejorar la productividad y adaptarte a los proyectos más exigentes.</p>
      </div>
